...
#NaN values will mess with numpy later so should be dealt with now. Setting all these to year=0 is functionally equivalent to ensuring these interactions are always the training set.
